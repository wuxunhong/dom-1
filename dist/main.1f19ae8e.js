...
var nodes = dom.empty(window.empty); //获取所有的节点

console.log(nodes); // 改

dom.attr(test, 'title', 'Hi,I am wxh'); //三个参数写

var title = dom.attr(test, 'title'); //两个参数读

console.log("title:".concat(title)); //读完后输出
...
console.log(dom.class.has(test, 'blue')); // 监听

var fn = function fn() {
  console.log('点击了');
};

dom.on(test, 'click', fn); // 删除监听
